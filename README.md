...
- **Research** — Ask any question, get a synthesized answer from multiple pages
- **Search** — Find the 5 most relevant pages on any site
- **Summarize** — Get a concise summary of the current page
- **Contact** — Instantly find contact info, FAQ, and support pages
- **Site Search** — Use the site's own search, filtered by AI
...
5. Open Settings to check your AI login status
6. Go to any website and start asking
